...
//        }
        ...
        try {
            ...
            if (!$this->db) {
                echo "We couldn't initialize the database.".PHP_EOL;
                return;
            }
            ...
            echo "Something bad happened: " . $e->getMessage() . PHP_EOL;
        }
    }
    ...
    public function onPrivmsg()
    {
        ...
        // Incrementation/decrementation request
            ...
            // Also $this->debug, what is happening with that
